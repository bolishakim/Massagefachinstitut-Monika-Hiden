...
export const auditController = {
    ...
    async getAuditLogs(req, res) {
        try {
            ...
            const { startDate, endDate, userId, action, resource, resourceId, ipAddress, page = '1', limit = '50' } = req.query;
            const query = {
    ...
    // Get GDPR audit logs
    async getGDPRAuditLogs(req, res) {
        try {
            ...
            const { startDate, endDate, userId, action, resourceId, page = '1', limit = '50' } = req.query;
            const query = {
                startDate: startDate ? new Date(startDate) : undefined,
                endDate: endDate ? new Date(endDate) : undefined,
                userId: userId,
    ...
    async getPatientAccessReport(req, res) {
        try {
            ...
            const result = await auditService.getPatientAccessReport(patientId, parseInt(days, 10));
            res.json({
                success: true,
                data: result
            });
    ...
    async getSystemActivitySummary(req, res) {
        try {
            ...
            const result = await auditService.getSystemActivitySummary(parseInt(days, 10));
            res.json({
                success: true,
                data: result
            });
    ...
    async getSecurityEvents(req, res) {
        try {
            ...
            const result = await auditService.getSecurityEvents(parseInt(hours, 10));
            res.json({
                success: true,
                data: result
            });
    ...
    async getMyAuditLogs(req, res) {
        try {
            ...
            const { startDate, endDate, action, resource, page = '1', limit = '50' } = req.query;
            const query = {
                startDate: startDate ? new Date(startDate) : undefined,
                endDate: endDate ? new Date(endDate) : undefined,
    ...
    async getAuditLogFilterOptions(req, res) {
        try {
    ...
    async getGDPRLogFilterOptions(req, res) {
        try {
