...
export const appointmentController = {
    ...
    getAllAppointments: async (req, res) => {
        try {
            const { page = '1', limit = '10', search = '', status, staffId, roomId, patientId, packageId, date, startDate, endDate, sortBy = 'scheduledDate', sortOrder = 'desc' } = req.query;
        ...
        try {
            ...
            const availableStaff = allStaff.filter(staff => {
                ...
                if (schedule.breakStartTime && schedule.breakEndTime) {
                    const isInBreak = ((startTime >= schedule.breakStartTime && startTime < schedule.breakEndTime) ||
...
async function updatePackagePaymentStatus(packageId) {
