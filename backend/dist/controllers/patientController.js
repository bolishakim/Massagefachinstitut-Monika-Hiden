...
export const createPatient = async (req, res) => {
    try {
        ...
        await AuditService.logCreate(req, 'Patient', patient.id, AuditService.cleanSensitiveData(patient), `Created patient: ${patient.firstName} ${patient.lastName}`);
        res.status(201).json({
            success: true,
            data: patient,
...
export const updatePatient = async (req, res) => {
    try {
        ...
        await AuditService.logUpdate(req, 'Patient', patient.id, AuditService.cleanSensitiveData(existingPatient), AuditService.cleanSensitiveData(patient), `Updated patient: ${patient.firstName} ${patient.lastName}`);
        res.json({
            success: true,
            data: patient,
...
export const deletePatient = async (req, res) => {
    try {
        ...
        await AuditService.logDelete(req, 'Patient', id, AuditService.cleanSensitiveData(existingPatient), `Soft deleted patient: ${existingPatient.firstName} ${existingPatient.lastName}`);
        res.json({
            success: true,
...
export const bulkDeletePatients = async (req, res) => {
    try {
        ...
        for (const patient of existingPatients) {
            await AuditService.logDelete(req, 'Patient', patient.id, AuditService.cleanSensitiveData(patient), `Bulk soft deleted patient: ${patient.firstName} ${patient.lastName}`);
        }
        res.json({
            success: true,
...
export const reactivatePatient = async (req, res) => {
    try {
        ...
        await AuditService.logUpdate(req, 'Patient', id, AuditService.cleanSensitiveData(existingPatient), AuditService.cleanSensitiveData(reactivatedPatient), `Reactivated patient: ${existingPatient.firstName} ${existingPatient.lastName}`);
        res.json({
            success: true,
