 ...
 */
export function calculateSessionCountFromServiceName(serviceName) {
 ...
 */
export function getTotalSessionsForPackageItem(packageItemCount, serviceSessionCount) {
    return packageItemCount * serviceSessionCount;
}
/**
 * Helper function to get the total used sessions for a package item
 */
export function getUsedSessionsForPackageItem(completedCount, serviceSessionCount) {
    return completedCount * serviceSessionCount;
}
//# sourceMappingURL=sessionCalculator.js.map