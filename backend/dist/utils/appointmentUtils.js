...
export async function validateAppointmentTime(staffId, date, startTime, endTime) {
...
export async function checkTimeConflict(date, startTime, endTime, roomId, staffId, excludeAppointmentId) {
    const appointmentDate = new Date(date);
    const where = {
...
export async function getAvailableTimeSlots(date, staffId, serviceDuration, timeSlotInterval = 30) {
