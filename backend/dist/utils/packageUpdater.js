...
export class PackageUpdater {
     ...
     */
    static async updatePackageSessions(packageId) {
        try {
     ...
     */
    static async updateMultiplePackages(packageIds) {
     ...
     */
    static async recalculateAllPackages() {
        try {
