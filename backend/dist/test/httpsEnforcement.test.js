...
async function runTests() {
    ...
    test('HSTS headers are set for secure connections', () => {
        ...
        const req = createMockRequest({ secure: true });
        const { res, headers } = createMockResponse();
        const next = () => { };
        middleware.enforce()(req, res, next);
    ...
    test('Enhanced security headers are set', () => {
        ...
        const { res, headers } = createMockResponse();
        const next = () => { };
        HttpsEnforcementMiddleware.securityHeaders()(req, res, next);
    ...
    test('Cache control headers are set for sensitive routes', () => {
        const req = createMockRequest({ path: '/api/patients/123' });
        const { res, headers } = createMockResponse();
        const next = () => { };
        HttpsEnforcementMiddleware.securityHeaders()(req, res, next);
...
export { runTests };
//# sourceMappingURL=httpsEnforcement.test.js.map