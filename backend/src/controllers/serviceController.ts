...
export const createService = async (req: Request, res: Response) => {
  try {
    ...
    await AuditService.logCreate(
      ...
      'Service',
      service.id,
      AuditService.cleanSensitiveData(service),
...
export const updateService = async (req: Request, res: Response) => {
  try {
    ...
    await AuditService.logUpdate(
      ...
      'Service',
      service.id,
      AuditService.cleanSensitiveData(existingService),
      AuditService.cleanSensitiveData(service),
...
export const deleteService = async (req: Request, res: Response) => {
  try {
    ...
    await AuditService.logDelete(
      ...
      id,
      AuditService.cleanSensitiveData(existingService),
      `Soft deleted service: ${existingService.name}`
    );
...
export const bulkDeleteServices = async (req: Request, res: Response) => {
  try {
    ...
    for (const service of existingServices) {
      await AuditService.logDelete(
        ...
        service.id,
        AuditService.cleanSensitiveData(service),
        `Bulk soft deleted service: ${service.name}`
      );
    }
...
export const reactivateService = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    ...
    await AuditService.logUpdate(
      ...
      id,
      AuditService.cleanSensitiveData(existingService),
      AuditService.cleanSensitiveData(reactivatedService),
      `Reactivated service: ${existingService.name}`
    );
