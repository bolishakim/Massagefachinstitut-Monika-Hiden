...
export const createRoom = async (req: Request, res: Response) => {
  try {
    ...
    await AuditService.logCreate(
      ...
      'Room',
      room.id,
      AuditService.cleanSensitiveData(room),
...
export const updateRoom = async (req: Request, res: Response) => {
  try {
    ...
    await AuditService.logUpdate(
      ...
      'Room',
      room.id,
      AuditService.cleanSensitiveData(existingRoom),
      AuditService.cleanSensitiveData(room),
...
export const deleteRoom = async (req: Request, res: Response) => {
  try {
    ...
    await AuditService.logDelete(
      ...
      id,
      AuditService.cleanSensitiveData(existingRoom),
      `Soft deleted room: ${existingRoom.name}`
    );
  ...
  try {
    ...
    for (const room of existingRooms) {
      await AuditService.logDelete(
        ...
        room.id,
        AuditService.cleanSensitiveData(room),
        `Bulk soft deleted room: ${room.name}`
      );
    }
...
export const reactivateRoom = async (req: Request, res: Response) => {
  try {
    ...
    await AuditService.logUpdate(
      ...
      id,
      AuditService.cleanSensitiveData(existingRoom),
      AuditService.cleanSensitiveData(reactivatedRoom),
      `Reactivated room: ${existingRoom.name}`
    );
