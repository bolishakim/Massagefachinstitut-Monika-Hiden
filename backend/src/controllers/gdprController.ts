 ...
 */
export const requestPatientDeletion = async (req: Request, res: Response) => {
  try {
 ...
 */
export const exportPatientData = async (req: Request, res: Response) => {
  try {
    const { patientId } = req.params;
    const user = (req as any).user;
 ...
 */
export const downloadPatientExport = async (req: Request, res: Response) => {
  try {
    const { filename } = req.params;
    const user = (req as any).user;
