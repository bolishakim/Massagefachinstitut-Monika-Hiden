...
export const calendarController = {
  ...
  getCalendarSettings: async (req: AuthRequest, res: Response) => {
    try {
  ...
  updateCalendarSettings: async (req: AuthRequest, res: Response) => {
    try {
      const userId = req.params.userId || req.user?.id;
  ...
  getDailySchedule: async (req: AuthRequest, res: Response) => {
    try {
  ...
  getStaffAvailability: async (req: AuthRequest, res: Response) => {
    try {
  ...
  checkConflicts: async (req: AuthRequest, res: Response) => {
    try {
